...
export function Sidebar({
  ...
  return (
    <motion.aside 
        className="h-screen bg-card/50 border-r flex flex-col shrink-0"
        animate={{ width: isSidebarOpen ? expandedWidth : collapsedWidth }}
        transition={{ duration: 0.3, ease: 'easeInOut' }}
    >
      <div className="p-3 flex flex-col overflow-hidden h-full">
        <header className={cn("shrink-0 pb-4 border-b transition-all", isSidebarOpen ? 'px-1' : 'px-0')}>
            ...
            <AnimatePresence>
              {isSidebarOpen && (
                ...
                >
                  ...
                  <h1 className="font-heading text-2xl tracking-tight text-primary whitespace-nowrap">Skill Garden</h1>
                </motion.div>
              )}
            </AnimatePresence>
        ...
        <div className="flex-grow flex flex-col min-h-0 my-4">
        ...
        <footer className="shrink-0 pt-4 border-t space-y-2">
          ...
          <div className={cn("p-2 rounded-lg bg-muted/50 border", !isSidebarOpen && 'p-0 border-none bg-transparent')}>
            <div className={cn("flex items-center gap-3", !isSidebarOpen && "justify-center")}>
              <Avatar className={cn(isSidebarOpen ? 'size-9' : 'size-10')}>
