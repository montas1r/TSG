...
export function Sidebar({
  ...
  return (
    <motion.aside 
        className="h-full bg-card/50 border-r flex flex-col absolute top-0 left-0 z-20"
        animate={{ width: isSidebarOpen ? sidebarWidth : 0 }}
        transition={{ duration: 0.3, ease: 'easeInOut' }}
    >
      <div className="p-4 flex flex-col overflow-hidden h-full" style={{ width: sidebarWidth }}>
